...
const CartIcon = () => {
    return (
        <svg version="1.1" id="Layer_1" x="0px" y="0px"
            width="20px" height="20px" viewBox="0 0 50 40" style={{ fill: 'var(--primary-color)' }}>
            <g id="Page-1_4_">
                <g id="Desktop_4_" transform="translate(-84.000000, -410.000000)">
                    <path id="Cart" className="st0" d="M94.5,434.6h24.8l4.7-15.7H92.2l-1.3-8.9H84v4.8h3.1l3.7,27.8h0.1
